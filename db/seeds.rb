...
SkillCard.create(name: 'Barbaric Insight', class_id: 1, card_type: 'buff', cost: 1, attack_type: 'mp', attack_targets: 1, damage: 0, description: 'Grants Insight, preventing ranged damage for 1 turn', bonus_method: 'barbarian_insight', buff_id: nil, debuff_id: nil, cooldown: 1, image_path: 'overpower.png')
