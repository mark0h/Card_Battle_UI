...
#Add Assassin Skill cards
SkillCard.create(name: 'Wind Slash', class_id: 3, card_type: 'attack', cost: 1, attack_type: 'mp', attack_targets: 1, damage: 4, description: 'Attacks single target repeatedly. ', bonus_method: 'assassin_windslash', buff_id: nil, debuff_id: nil, cooldown: 0, image_path: 'windslash.png')
SkillCard.create(name: 'Rupture', class_id: 3, card_type: 'attack', cost: 1, attack_type: 'mp', attack_targets: 1, damage: 2, description: 'Targets vital arteries, causing Bleed. ', bonus_method: 'assassin_rupture', buff_id: nil, debuff_id: nil, cooldown: 1, image_path: 'rupture.png')
SkillCard.create(name: 'Fan of Knives', class_id: 3, card_type: 'defense', cost: 1, attack_type: 'rp', attack_targets: 1, damage: 4, description: 'Defensive move that retaliates with a fury of knives. ', bonus_method: 'assassin_fan_of_knives', buff_id: nil, debuff_id: nil, cooldown: 1, image_path: 'fan_of_knives.png')
SkillCard.create(name: 'Expose Weakness', class_id: 3, card_type: 'attack', cost: 2, attack_type: 'mp', attack_targets: 1, damage: 4, description: 'Reveals weaknesses, applies Defeneseless', bonus_method: 'assassin_expose_weakness', buff_id: nil, debuff_id: nil, cooldown: 1, image_path: 'expose_weakness.png')
SkillCard.create(name: 'Poison Needles', class_id: 3, card_type: 'defense', cost: 2, attack_type: 'rp', attack_targets: 1, damage: 6, description: 'Ranged defense that also poisons', bonus_method: 'assassin_poison_needles', buff_id: nil, debuff_id: nil, cooldown: 2, image_path: 'poison_needles.png')
SkillCard.create(name: 'Shadow Strikes', class_id: 3, card_type: 'attack', cost: 4, attack_type: 'ms', attack_targets: 1, damage: 12, description: 'Powerful attack of darkness. ', bonus_method: 'assassin_shadow_strikes', buff_id: nil, debuff_id: nil, cooldown: 3, image_path: 'shadow_strikes.png')
SkillCard.create(name: 'Phase Blade', class_id: 3, card_type: 'attack', cost: 3, attack_type: 'rp', attack_targets: 1, damage: 8, description: 'Using precise attacks, applying Fatigue. ', bonus_method: 'assassin_phaseblade', buff_id: nil, debuff_id: nil, cooldown: 2, image_path: 'phase_blade.png')
SkillCard.create(name: 'Backstab', class_id: 3, card_type: 'attack', cost: 3, attack_type: 'mp', attack_targets: 1, damage: 6, description: 'Punctures vital organs, causing Bleed. ', bonus_method: 'assassin_backstab', buff_id: nil, debuff_id: nil, cooldown: 2, image_path: 'backstab.png')
